...
Description: Solution for stage 1 IOOF code test requirement.
Script use an input file to process following actions only:
    PLACE
    MOVE
    LEFT
    RIGHT
...
$global:FileData= Get-Content F:\test.txt;
$global:CharArray;
$global:CharSubArray;
